package com.metao.asyncdownloader.download.core.mainWorker;

import android.util.Log;
import android.webkit.MimeTypeMap;
import com.metao.asyncdownloader.download.appConstants.DispatchEcode;
import com.metao.asyncdownloader.download.appConstants.DispatchElevel;
import com.metao.asyncdownloader.download.core.chunkWorker.Builder;
...
//					DispatchEcode.EXCEPTION, DispatchElevel.URL_INVALID);
            Log.d(DispatchEcode.EXCEPTION, DispatchElevel.URL_INVALID + ":>" + task.url);
            return false;
