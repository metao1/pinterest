...
/**
 * An interface for an object that is both a {@link com.metao.asyncdownloader.repository.request.target.Target} and a
 * {@link Future}. For example:
 * <pre>
 * {@code
 * FutureTarget<Bitmap> futureTarget = ImageDownloader.with(fragment)
