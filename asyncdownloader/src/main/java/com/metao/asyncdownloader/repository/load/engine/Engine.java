...
import com.metao.asyncdownloader.repository.load.engine.cache.DiskCacheAdapter;
...
import com.metao.asyncdownloader.repository.request.ResourceCallback;
...
public class Engine implements EngineJobListener,
  ...
  // Lazily instantiate to avoid exceptions if ImageDownloader is initialized on a background thread. See
  // #295.
  ...
  public Engine(MemoryCache memoryCache,
      ...
      ImageDownloaderExecutor diskCacheExecutor,
      ImageDownloaderExecutor sourceExecutor,
      ImageDownloaderExecutor sourceUnlimitedExecutor) {
  ...
  static class DecodeJobFactory {
    ...
    @SuppressWarnings("unchecked")
    <R> DecodeJob<R> build(ImageDownloaderContext ImageDownloaderContext,
        Object model,
        EngineKey loadKey,
        Key signature,
        int width,
  ...
  static class EngineJobFactory {
    @Synthetic final ImageDownloaderExecutor diskCacheExecutor;
    @Synthetic final ImageDownloaderExecutor sourceExecutor;
    @Synthetic final ImageDownloaderExecutor sourceUnlimitedExecutor;
    ...
    EngineJobFactory(ImageDownloaderExecutor diskCacheExecutor, ImageDownloaderExecutor sourceExecutor,
        ImageDownloaderExecutor sourceUnlimitedExecutor, EngineJobListener listener) {
