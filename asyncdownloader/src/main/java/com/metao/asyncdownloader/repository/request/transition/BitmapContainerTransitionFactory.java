...
public abstract class BitmapContainerTransitionFactory<R> implements TransitionFactory<R> {
  ...
  public Transition<R> build(DataSource dataSource, boolean isFirstResource) {
    ...
    return new BitmapImageDownloaderAnimation(transition);
  }
  ...
  private class BitmapImageDownloaderAnimation implements Transition<R> {
    private final Transition<Drawable> transition;

    public BitmapImageDownloaderAnimation(Transition<Drawable> transition) {
