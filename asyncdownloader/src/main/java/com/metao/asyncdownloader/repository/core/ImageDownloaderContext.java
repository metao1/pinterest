...
/**
 * Global context for all loads in ImageDownloader containing and exposing the various registries and classes
 * required to load resources.
 */
@TargetApi(Build.VERSION_CODES.ICE_CREAM_SANDWICH)
public class ImageDownloaderContext extends ContextWrapper implements ComponentCallbacks2 {
  ...
  public ImageDownloaderContext(Context context, Registry registry,
