...
/**
 * A ImageDownloader {@link BitmapTransformation} to circle crop an image.  Behaves similar to a
...
public class CircleCrop extends BitmapTransformation {
  ...
  private static final String ID = "com.metao.asyncdownloader.repository.core.CircleCrop." + VERSION;
