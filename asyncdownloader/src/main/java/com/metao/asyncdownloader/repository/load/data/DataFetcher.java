 ...
 *
 * <p> A new instance is
 * created per resource load by {@link com.metao.asyncdownloader.repository.load.model.ModelLoader}. {@link
 * #loadData(com.metao.asyncdownloader.repository.imagehandler.Priority, com.metao.asyncdownloader.repository.load.data.DataFetcher.DataCallback)}
 ...
 * {@link #loadData(com.metao.asyncdownloader.repository.imagehandler.Priority,
 * com.metao.asyncdownloader.repository.load.data.DataFetcher.DataCallback)}} is called, then so {@link #cleanup()}
 * will be called. </p>
 *
...
public interface DataFetcher<T> {
   ...
   * finally block after the data provided by {@link #loadData(com.metao.asyncdownloader.repository.imagehandler.Priority,
   * com.metao.asyncdownloader.repository.load.data.DataFetcher.DataCallback)} has been decoded by the
   * {@link com.metao.asyncdownloader.repository.load.ResourceDecoder}.
   *
   * <p> Note - this method will be run on a background thread so blocking I/O is safe. </p>
   */
  void cleanup();
  ...
  /**
   * Returns the {@link com.metao.asyncdownloader.repository.load.DataSource} this fetcher will return data from.
   */
