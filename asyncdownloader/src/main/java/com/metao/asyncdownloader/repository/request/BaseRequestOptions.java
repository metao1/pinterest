...
import com.metao.asyncdownloader.repository.core.*;
...
import com.metao.asyncdownloader.repository.core.BitmapDrawableTransformation;
import com.metao.asyncdownloader.repository.core.BitmapEncoder;
import com.metao.asyncdownloader.repository.core.CenterCrop;
import com.metao.asyncdownloader.repository.core.CenterInside;
import com.metao.asyncdownloader.repository.core.CircleCrop;
import com.metao.asyncdownloader.repository.core.DownsampleStrategy;
import com.metao.asyncdownloader.repository.core.Downsampler;
import com.metao.asyncdownloader.repository.core.FitCenter;
import com.metao.asyncdownloader.repository.core.VideoBitmapDecoder;
import com.metao.asyncdownloader.repository.signature.EmptySignature;
...
public abstract class BaseRequestOptions<CHILD extends BaseRequestOptions<CHILD>>
  ...
  /**
   * Applies a multiplier to the {@link com.metao.asyncdownloader.repository.request.target.Target}'s size before
   ...
   *                       {@link com.metao.asyncdownloader.repository.request.target.Target}'s dimensions when
  ...
  /**
   * Sets the {@link com.metao.asyncdownloader.repository.load.engine.DiskCacheStrategy} to use for this load.
   *
   * <p> Defaults to {@link com.metao.asyncdownloader.repository.load.engine.DiskCacheStrategy#AUTOMATIC}. </p>
   *
   * <p> For most applications {@link com.metao.asyncdownloader.repository.load.engine.DiskCacheStrategy#RESOURCE} is
   ...
   * using {@link com.metao.asyncdownloader.repository.load.engine.DiskCacheStrategy#DATA} or
   * {@link com.metao.asyncdownloader.repository.load.engine.DiskCacheStrategy#ALL}. </p>
   *
   ...
   * {@link com.metao.asyncdownloader.repository.imagehandler.RequestBuilder#load(Object)} is {@code null}.
   *
  ...
  /**
   * Overrides the {@link com.metao.asyncdownloader.repository.request.target.Target}'s width and height with the
   ...
   *
   * @param signature A unique non-null {@link com.metao.asyncdownloader.repository.load.Key} representing the current
   *                  state of the model that will be mixed in to the cache key.
   * @return This request builder.
   * @see com.metao.asyncdownloader.repository.signature.ObjectKey
   */
   ...
   * @see #optionalTransform(Class, com.metao.asyncdownloader.repository.load.Transformation)
   ...
   *
   * @param context Any {@link Context}.
   * @see #transform(Class, com.metao.asyncdownloader.repository.load.Transformation)
  ...
  /**
   * Applies the given {@link com.metao.asyncdownloader.repository.load.Transformation} for
   ...
   *
   * @param context        Any {@link Context}.
   * @param transformation Any {@link com.metao.asyncdownloader.repository.load.Transformation} for
   *                       {@link Bitmap}s.
   * @see #optionalTransform(Context, com.metao.asyncdownloader.repository.load.Transformation)
   * @see #optionalTransform(Class, com.metao.asyncdownloader.repository.load.Transformation)
   */
   ...
   * @param transformation Any {@link com.metao.asyncdownloader.repository.load.Transformation} for
   *                       {@link Bitmap}s.
   * @see #transform(Context, com.metao.asyncdownloader.repository.load.Transformation)
   * @see #transform(Class, com.metao.asyncdownloader.repository.load.Transformation)
   */
  ...
  /**
   * Applies the given {@link com.metao.asyncdownloader.repository.load.Transformation} for any decoded resource of
   ...
   * {@link com.metao.asyncdownloader.repository.load.Transformation} for a resource type that already has a
   * {@link com.metao.asyncdownloader.repository.load.Transformation} will override the previous call. </p>
   *
   ...
   * @param transformation The {@link com.metao.asyncdownloader.repository.load.Transformation} to apply.
   */
  ...
  /**
   * Removes all applied {@link com.metao.asyncdownloader.repository.load.Transformation Transformations} for all
   ...
   * {@link com.metao.asyncdownloader.repository.imagehandler.TransitionOptions#dontTransition()}</p>
   */
