...
/**
 * Generates a series of {@link com.metao.asyncdownloader.repository.load.data.DataFetcher DataFetchers} using
 * registered {@link com.metao.asyncdownloader.repository.load.model.ModelLoader ModelLoaders} and a model.
 */
interface DataFetcherGenerator {
  /**
   * Called when the generator has finished loading data from a
   * {@link com.metao.asyncdownloader.repository.load.data.DataFetcher}.
   */
  interface FetcherReadyCallback {

    /**
     * Requests that we call startNext() again on a ImageDownloader owned thread.
     */
    void reschedule();
  ...
  /**
   * Attempts to a single new {@link com.metao.asyncdownloader.repository.load.data.DataFetcher} and returns true if
   * a {@link com.metao.asyncdownloader.repository.load.data.DataFetcher} was started, and false otherwise.
   */
  boolean startNext();
