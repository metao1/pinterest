...
import com.metao.asyncdownloader.repository.request.transition.NoTransition;
import com.metao.asyncdownloader.repository.request.transition.TransitionFactory;
import com.metao.asyncdownloader.repository.request.transition.ViewAnimationFactory;
import com.metao.asyncdownloader.repository.request.transition.ViewPropertyAnimationFactory;
import com.metao.asyncdownloader.repository.request.transition.ViewPropertyTransition;
...
public abstract class TransitionOptions<CHILD extends TransitionOptions<CHILD, TranscodeType>,
   ...
   *
   * @param animator The {@link com.metao.asyncdownloader.repository.imagehandler.request.transition.ViewPropertyTransition
   *                 .Animator} to run.
   * @return This request builder.
   */
