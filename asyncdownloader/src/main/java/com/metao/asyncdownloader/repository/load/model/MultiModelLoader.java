...
import com.metao.asyncdownloader.repository.load.data.DataFetcher.DataCallback;
 ...
 * com.metao.asyncdownloader.repository.load.engine.DataFetcherGenerator} implementations and should try to avoid this
 * duplication. </p>
 */
  ...
  static class MultiFetcher<Data> implements DataFetcher<Data>, DataCallback<Data> {
    ...
    private void startNextOrFail() {
      if (currentIndex < fetchers.size() - 1) {
        ...
        callback.onLoadFailed(new ImageDownloaderException("Fetch failed", new ArrayList<>(exceptions)));
      }
    }
  }
}
