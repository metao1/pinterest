...
/**
 * A simple {@link com.metao.asyncdownloader.repository.request.target.Target} base class with default (usually noop)
 ...
 * <pre>
 * <code>
 * ImageDownloader.load("http://somefakeurl.com/fakeImage.jpeg")
 *      .asBitmap()
 *      .withFitCenter()
 *      .into(new SimpleTarget<Bitmap>(250, 250) {
 *
 *          {@literal @Override}
 *          public void onResourceReady(Bitmap resource, ImageDownloaderAnimation<Bitmap> ImageDownloaderAnimation) {
