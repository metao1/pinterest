package com.metao.asyncdownloader.repository.load.engine.executor;
...
/**
 * A prioritized {@link ThreadPoolExecutor} for running jobs in ImageDownloader.
 */
public final class ImageDownloaderExecutor extends ThreadPoolExecutor {
   ...
   * ImageDownloader's cache.
   */
  public static final String DEFAULT_DISK_CACHE_EXECUTOR_NAME = "disk-cache";
  /**
   * The default thread count for executors used to load/decode/transform data found in ImageDownloader's
   * cache.
   */
  public static final int DEFAULT_DISK_CACHE_EXECUTOR_THREADS = 1;

  private static final String TAG = "ImageDownloaderExecutor";
   ...
   * prefix, and the
   * {@link com.metao.asyncdownloader.repository.load.engine.executor.ImageDownloaderExecutor.UncaughtThrowableStrategy#DEFAULT}
   * uncaught throwable strategy.
   *
   * <p>Disk cache executors do not allow network operations on their threads.
   */
  public static ImageDownloaderExecutor newDiskCacheExecutor() {
   ...
   * and {@link com.metao.asyncdownloader.repository.load.engine.executor.ImageDownloaderExecutor.UncaughtThrowableStrategy}.
   *
   * <p>Disk cache executors do not allow network operations on their threads.
   *
   ...
   * com.metao.asyncdownloader.repository.load.engine.executor.ImageDownloaderExecutor.UncaughtThrowableStrategy} to use to
   *                                  handle uncaught exceptions.
   */
  public static ImageDownloaderExecutor newDiskCacheExecutor(int threadCount, String name,
      UncaughtThrowableStrategy uncaughtThrowableStrategy) {
    return new ImageDownloaderExecutor(threadCount, name, uncaughtThrowableStrategy,
   ...
   */
  public static ImageDownloaderExecutor newSourceExecutor() {
   ...
   *                                  handle uncaught exceptions.
   */
  public static ImageDownloaderExecutor newSourceExecutor(int threadCount, String name,
      UncaughtThrowableStrategy uncaughtThrowableStrategy) {
    return new ImageDownloaderExecutor(threadCount, name, uncaughtThrowableStrategy,
   ...
   * <p>Source executors allow network operations on their threads.
   */
  public static ImageDownloaderExecutor newUnlimitedSourceExecutor() {
    return new ImageDownloaderExecutor(0 /* corePoolSize */,
  ...
  // Visible for testing.
  ImageDownloaderExecutor(int poolSize, String name,
  ...
  ImageDownloaderExecutor(int corePoolSize, int maximumPoolSize, long keepAliveTimeInMs, String name,
      UncaughtThrowableStrategy uncaughtThrowableStrategy, boolean preventNetworkOperations,
      boolean executeSynchronously) {
    this(
        corePoolSize,
  ...
  public static int calculateBestThreadCount() {
    ...
    // See: https://github.com/bumptech/ImageDownloader/issues/1170
  ...
  private static final class DefaultThreadFactory implements ThreadFactory {
    ...
    public synchronized Thread newThread(@NonNull Runnable runnable) {
      final Thread result = new Thread(runnable, "ImageDownloader-" + name + "-thread-" + threadNum) {
        @Override
        public void run() {
