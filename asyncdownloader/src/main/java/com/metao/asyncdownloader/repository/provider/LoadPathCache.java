package com.metao.asyncdownloader.repository.provider;

import android.support.annotation.Nullable;
import android.support.v4.util.ArrayMap;
import com.metao.asyncdownloader.repository.load.engine.LoadPath;
import com.metao.asyncdownloader.repository.util.MultiClassKey;
import java.util.concurrent.atomic.AtomicReference;

/**
 * Maintains a cache of data, resource, and transcode classes to available
 * {@link com.metao.asyncdownloader.repository.load.engine.LoadPath}s capable of decoding with the requested types.
 */
