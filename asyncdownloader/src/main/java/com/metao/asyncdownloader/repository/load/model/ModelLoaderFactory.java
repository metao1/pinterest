 ...
 *
 * @param <T> The type of the model the {@link com.metao.asyncdownloader.repository.load.model.ModelLoader}s built by
 *            this factory can handle
 * @param <Y> The type of data the {@link com.metao.asyncdownloader.repository.load.model.ModelLoader}s built by this
 *            factory can load.
 */
