...
import com.metao.asyncdownloader.repository.load.data.ExifOrientationStream;
import com.metao.asyncdownloader.repository.core.ThumbnailQuery;
import com.metao.asyncdownloader.repository.core.ThumbnailStreamOpener;
...
public class ThumbFetcher implements DataFetcher<InputStream> {
  ...
  // TODO(nnaze): These build methods do not need the full ImageDownloader or Context objects.
  ...
  private static ThumbFetcher build(Context context, Uri uri, ThumbnailQuery query) {
    ArrayPool byteArrayPool = ImageDownloader.get(context).getArrayPool();
    ThumbnailStreamOpener opener = new ThumbnailStreamOpener(
        ImageDownloader.get(context).getRegistry().getImageHeaderParsers(), query, byteArrayPool,
