...
/**
 * An {@link com.metao.asyncdownloader.repository.load.Transformation} that wraps a transformation for a
...
public class GifDrawableTransformation implements Transformation<GifDrawable> {
  ...
  public GifDrawableTransformation(Context context, Transformation<Bitmap> wrapped) {
    this(wrapped, ImageDownloader.get(context).getBitmapPool());
  }
