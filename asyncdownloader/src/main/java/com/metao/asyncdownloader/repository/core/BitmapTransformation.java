...
/**
 * A simple {@link com.metao.asyncdownloader.repository.load.Transformation} for transforming
 * {@link Bitmap}s that abstracts away dealing with
 * {@link com.metao.asyncdownloader.repository.load.engine.Resource} objects for subclasses.
 *
 * Use cases will look something like this:
 * <pre>
 * <code>
 * public class FillSpace extends BaseBitmapTransformation {
 *     private static final String ID = "com.metao.asyncdownloader.repository.imagehandler.transformations.FillSpace";
...
public abstract class BitmapTransformation implements Transformation<Bitmap> {
  ...
  public BitmapTransformation(Context context) {
    this(ImageDownloader.get(context).getBitmapPool());
  }
   ...
   *
   * <p>The provided Bitmap, toTransform, should not be recycled or returned to the pool. ImageDownloader will
   ...
   * {@link com.metao.asyncdownloader.repository.request.target.Target#SIZE_ORIGINAL},
   * this class converts them to be the size of the Bitmap we're going to transform before calling
   * this method.
   *
   * @param pool        A {@link com.metao.asyncdownloader.repository.load.engine.bitmap_recycle.BitmapPool} that can
