 ...
 * com.metao.asyncdownloader.repository.request.target.Target}s in across resource types. Targets that wrap views will
 ...
 * transition. This interface is a compromise that allows view specific transition in ImageDownloader's
