...
/**
 * A {@link java.util.concurrent.Future} implementation for ImageDownloader that can be used to load resources
 ...
 *      RequestManager requestManager = ImageDownloader.with(context);
 *      try {
