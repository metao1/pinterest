...
/**
 * An {@link com.metao.asyncdownloader.repository.load.ResourceDecoder} that can decode a thumbnail frame
...
public class VideoBitmapDecoder implements ResourceDecoder<ParcelFileDescriptor, Bitmap> {
  ...
  public static final Option<Long> TARGET_FRAME = Option.disk(
      "com.metao.asyncdownloader.repository.load.resource.bitmap.VideoBitmapDecode.TargetFrame", DEFAULT_FRAME,
  ...
  public static final Option<Integer> FRAME_OPTION = Option.disk(
      "com.metao.asyncdownloader.repository.load.resource.bitmap.VideoBitmapDecode.FrameOption",
      null /*defaultValue*/,
