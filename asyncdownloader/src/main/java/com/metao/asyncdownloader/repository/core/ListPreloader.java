...
import com.metao.asyncdownloader.repository.request.target.BaseTarget;
...
public class ListPreloader<T> implements AbsListView.OnScrollListener {
  ...
  /**
   * Constructor for {@link com.metao.asyncdownloader.repository.imagehandler.ListPreloader} that accepts interfaces for providing
