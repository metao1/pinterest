...
import com.metao.asyncdownloader.repository.load.HttpException;
import com.metao.asyncdownloader.repository.load.model.ImageDownloaderUrl;
import com.metao.asyncdownloader.repository.util.ContentLengthInputStream;
...
public class HttpUrlFetcher implements DataFetcher<InputStream> {
  ...
  private final ImageDownloaderUrl ImageDownloaderUrl;
  ...
  public HttpUrlFetcher(ImageDownloaderUrl ImageDownloaderUrl, int timeout) {
    this(ImageDownloaderUrl, timeout, DEFAULT_CONNECTION_FACTORY);
  }

  // Visible for testing.
  HttpUrlFetcher(ImageDownloaderUrl ImageDownloaderUrl, int timeout, HttpUrlConnectionFactory connectionFactory) {
    this.ImageDownloaderUrl = ImageDownloaderUrl;
  ...
  public void loadData(Priority priority, DataCallback<? super InputStream> callback) {
    ...
    try {
      result = loadDataWithRedirects(ImageDownloaderUrl.toURL(), 0 /*redirects*/, null /*lastUrl*/,
          ImageDownloaderUrl.getHeaders());
    } catch (IOException e) {
