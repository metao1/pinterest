 ...
 *
 * <p> This class can also optionally wrap {@link com.metao.asyncdownloader.repository.load.model.Headers} for
 * convenience. </p>
 */
public class ImageDownloaderUrl implements Key {
  ...
  public ImageDownloaderUrl(URL url) {
    this(url, Headers.DEFAULT);
  }

  public ImageDownloaderUrl(String url) {
    this(url, Headers.DEFAULT);
  }

  public ImageDownloaderUrl(URL url, Headers headers) {
    this.url = Preconditions.checkNotNull(url);
    stringUrl = null;
    this.headers = Preconditions.checkNotNull(headers);
  }

  public ImageDownloaderUrl(String url, Headers headers) {
    this.url = null;
  ...
  public boolean equals(Object o) {
    if (o instanceof ImageDownloaderUrl) {
      ImageDownloaderUrl other = (ImageDownloaderUrl) o;
