...
import com.metao.asyncdownloader.repository.core.LifecycleListener;
...
/**
 * An interface that ImageDownloader can load a resource into and notify of relevant lifecycle events during a
 * load.
 *
...
public interface Target<R> extends LifecycleListener {
  ...
  /**
   * Sets the current request for this target to retain, should not be called outside of ImageDownloader.
   */
  void setRequest(@Nullable Request request);

  /**
   * Retrieves the current request for this target, should not be called outside of ImageDownloader.
   */
  @Nullable
  Request getRequest();
}
