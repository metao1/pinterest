...
public abstract class DiskCacheStrategy {
   ...
   * {@link com.metao.asyncdownloader.repository.load.data.DataFetcher} and the
   * {@link com.metao.asyncdownloader.repository.load.EncodeStrategy} of the
   * {@link com.metao.asyncdownloader.repository.load.ResourceEncoder} (if an
   * {@link com.metao.asyncdownloader.repository.load.ResourceEncoder} is available).
   */
   ...
   * com.metao.asyncdownloader.repository.load.ResourceEncoder} will use to encode the resource.
   */
