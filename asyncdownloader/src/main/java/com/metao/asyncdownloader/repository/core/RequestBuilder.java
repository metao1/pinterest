...
import static com.metao.asyncdownloader.repository.request.RequestOptions.signatureOf;

import android.net.Uri;
import android.support.annotation.NonNull;
import android.support.annotation.Nullable;
import android.widget.ImageView;
import com.metao.asyncdownloader.repository.load.engine.DiskCacheStrategy;
import com.metao.asyncdownloader.repository.request.BaseRequestOptions;
import com.metao.asyncdownloader.repository.request.FutureTarget;
import com.metao.asyncdownloader.repository.request.Request;
import com.metao.asyncdownloader.repository.request.RequestCoordinator;
import com.metao.asyncdownloader.repository.request.RequestFutureTarget;
...
import com.metao.asyncdownloader.repository.request.SingleRequest;
import com.metao.asyncdownloader.repository.request.ThumbnailRequestCoordinator;
import com.metao.asyncdownloader.repository.request.target.PreloadTarget;
import com.metao.asyncdownloader.repository.request.target.Target;
import com.metao.asyncdownloader.repository.signature.ApplicationVersionSignature;
 ...
 * {@link com.metao.asyncdownloader.repository.imagehandler.request.target.Target}.
 */
public class RequestBuilder<TranscodeType> implements Cloneable {
  ...
  private final ImageDownloaderContext context;
  ...
  RequestBuilder(ImageDownloaderContext context, RequestManager requestManager,
   ...
   * com.metao.asyncdownloader.repository.imagehandler.load.model.ModelLoader}, {@link com.metao.asyncdownloader.repository.imagehandler.load.ResourceDecoder},
   * and {@link com.metao.asyncdownloader.repository.imagehandler.load.Transformation}s. However,
   * {@link com.metao.asyncdownloader.repository.imagehandler.request.BaseRequestOptions#placeholder(int)} and
   * {@link com.metao.asyncdownloader.repository.imagehandler.request.BaseRequestOptions#error(int)}, and
   ...
   * {@link #into(com.metao.asyncdownloader.repository.imagehandler.request.target.Target)} is called. </p>
   *
   ...
   * {@link com.metao.asyncdownloader.repository.imagehandler.request.BaseRequestOptions#signature(com.metao.asyncdownloader.repository.imagehandler.load.Key)} to
   ...
   * {@link com.metao.asyncdownloader.repository.imagehandler.load.engine.DiskCacheStrategy#NONE} and/or
   * {@link com.metao.asyncdownloader.repository.imagehandler.request.BaseRequestOptions#skipMemoryCache(boolean)} may be
   * appropriate.
   * </p>
   *
   * @see #load(Object)
   ...
   * {@link com.metao.asyncdownloader.repository.imagehandler.load.model.UriLoader}.
   */
   ...
   * {@link com.metao.asyncdownloader.repository.imagehandler.request.BaseRequestOptions#signature(com.metao.asyncdownloader.repository.imagehandler.load.Key)}
   ...
   * the {@link com.metao.asyncdownloader.repository.imagehandler.load.model.ModelLoaderFactory} currently registered or
   * {@link Integer} to load the image represented by the given {@link Integer} resource id.
   * Defaults to {@link com.metao.asyncdownloader.repository.imagehandler.load.model.ResourceLoader} to load resource id models.
   *
   * <p> By default this method adds a version code based signature to the cache key used to cache
   * this resource in ImageDownloader. This signature is sufficient to guarantee that end users will see the
   ...
   * using {@link com.metao.asyncdownloader.repository.imagehandler.load.engine.DiskCacheStrategy#NONE} via
   * {@link BaseRequestOptions#diskCacheStrategy(com.metao.asyncdownloader.repository.imagehandler.load.engine.DiskCacheStrategy)}
   * during development, and re-enabling the default
   * {@link com.metao.asyncdownloader.repository.imagehandler.load.engine.DiskCacheStrategy#RESOURCE} for release builds. </p>
   *
   * @see #load(Integer)
   * @see com.metao.asyncdownloader.repository.imagehandler.signature.ApplicationVersionSignature
   */
   ...
   * the view, and frees any resources ImageDownloader may have previously loaded into the view so they may be
   * reused.
   *
   * @see RequestManager#clear(Target)
   *
   ...
   * @return The
   * {@link com.metao.asyncdownloader.repository.imagehandler.request.target.Target} used to wrap the given {@link ImageView}.
   */
   ...
   *               overridden by
   *               {@link com.metao.asyncdownloader.repository.imagehandler.request.BaseRequestOptions#override(int, int)} if
   *               previously called.
   ...
   * @see com.metao.asyncdownloader.repository.imagehandler.ListPreloader
   */
