...
public abstract class ViewTarget<T extends View, Z> extends BaseTarget<Z> {
   ...
   *
   * <p> For ImageDownloader to function correctly, ImageDownloader must be the only thing that calls {@link
   * View#setTag(Object)}. If the tag is cleared or put to another object type, ImageDownloader will not be
   * able to retrieve and cancel previous loads which will not only prevent ImageDownloader from reusing
   ...
   * com.metao.asyncdownloader.repository.request.Request}. </p>
   */
  @Override
  @Nullable
    ...
    if (tag != null) {
      if (tag instanceof Request) {
        ...
        throw new IllegalArgumentException(
            "You must not call setTag() on a view ImageDownloader is targeting");
      }
    }
    return request;
  }
   ...
   *
   * <p>
   *   If no tag id is set, ImageDownloader will use {@link View#setTag(Object)}.
   * </p>
   *
   * <p>
   ...
   *   on older versions, be sure to call {@link com.metao.asyncdownloader.repository.imagehandler.RequestManager#clear(View)} on
