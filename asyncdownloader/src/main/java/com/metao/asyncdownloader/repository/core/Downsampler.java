...
public final class Downsampler {
  ...
  /**
   * Indicates the {@link com.metao.asyncdownloader.repository.load.DecodeFormat} that will be used in conjunction
  ...
  public static final Option<DecodeFormat> DECODE_FORMAT = Option.memory(
      "com.metao.asyncdownloader.repository.core.Downsampler.DecodeFormat", DecodeFormat.DEFAULT);
  /**
  ...
  public static final Option<DownsampleStrategy> DOWNSAMPLE_STRATEGY =
      Option.memory("com.metao.asyncdownloader.repository.core.Downsampler.DownsampleStrategy",
  ...
  public static final Option<Boolean> FIX_BITMAP_SIZE_TO_REQUESTED_DIMENSIONS =
      Option.memory("com.metao.asyncdownloader.repository.core.Downsampler.FixBitmapSize", false);
   ...
   * {@link com.metao.asyncdownloader.repository.load.engine.bitmap_recycle.BitmapPool} whose dimensions exactly match
