...
import com.metao.asyncdownloader.repository.core.RecyclableBufferedInputStream;
...
public final class InputStreamRewinder implements DataRewinder<InputStream> {
  ...
  /**
   * Factory for producing {@link com.metao.asyncdownloader.repository.load.data.InputStreamRewinder}s from {@link
   * InputStream}s.
   */
