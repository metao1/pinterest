package com.metao.asyncdownloader.repository.util.pool;
 ...
 * created, and that can use the {@link com.metao.asyncdownloader.repository.util.pool.FactoryPools.Poolable}
