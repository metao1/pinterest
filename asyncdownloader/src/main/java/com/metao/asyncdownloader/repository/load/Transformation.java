...
public interface Transformation<T> extends Key {
   ...
   * com.metao.asyncdownloader.repository.load.engine.DiskCacheStrategy#NONE} or make sure {@link
   ...
   *                  com.metao.asyncdownloader.repository.request.target.Target#SIZE_ORIGINAL} to indicate the
