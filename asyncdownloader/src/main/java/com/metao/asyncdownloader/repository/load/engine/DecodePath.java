...
public class DecodePath<DataType, ResourceType, Transcode> {
  ...
  public Resource<Transcode> decode(DataRewinder<DataType> rewinder, int width, int height,
      Options options, DecodeCallback<ResourceType> callback) throws ImageDownloaderException {
  ...
  private Resource<ResourceType> decodeResource(DataRewinder<DataType> rewinder, int width,
      int height, Options options) throws ImageDownloaderException {
  ...
  private Resource<ResourceType> decodeResourceWithList(DataRewinder<DataType> rewinder, int width,
      int height, Options options, List<Exception> exceptions) throws ImageDownloaderException {
