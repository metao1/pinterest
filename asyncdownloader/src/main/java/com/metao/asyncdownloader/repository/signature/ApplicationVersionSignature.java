...
/**
 * A utility class for obtaining a {@link com.metao.asyncdownloader.repository.load.Key} signature containing the
...
public final class ApplicationVersionSignature {
  ...
  /**
   * Returns the signature {@link com.metao.asyncdownloader.repository.load.Key} for version code of the Application
