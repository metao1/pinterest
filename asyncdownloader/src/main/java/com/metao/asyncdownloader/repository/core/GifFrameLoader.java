...
import com.metao.asyncdownloader.repository.core.RequestBuilder;
import com.metao.asyncdownloader.repository.core.RequestManager;
...
import com.metao.asyncdownloader.repository.request.target.SimpleTarget;
...
class GifFrameLoader {
  ...
  public GifFrameLoader(
      ...
      Bitmap firstFrame) {
    this(
        imageDownloader.getContext(),
        imageDownloader.getBitmapPool(),
        ImageDownloader.with(imageDownloader.getContext()),
        gifDecoder,
        null /*handler*/,
        getRequestBuilder(ImageDownloader.with(imageDownloader.getContext()), width, height),
        transformation,
        firstFrame);
  }
