 ...
 * {@link com.metao.asyncdownloader.repository.load.ResourceDecoder} to decode a resource.
 */
public interface ModelLoader<Model, Data> {

  /**
   * Contains a set of {@link com.metao.asyncdownloader.repository.load.Key Keys} identifying the source of the load,
   * alternate cache keys pointing to equivalent data, and a
   * {@link com.metao.asyncdownloader.repository.load.data.DataFetcher} that can be used to fetch data not found in
   * cache.
   *
  ...
  /**
   * Returns a {@link com.metao.asyncdownloader.repository.load.model.ModelLoader.LoadData} containing a
   * {@link com.metao.asyncdownloader.repository.load.data.DataFetcher} required to decode the resource
   * represented by this model, as well as a set of {@link com.metao.asyncdownloader.repository.load.Key Keys} that
   * identify the data loaded by the {@link com.metao.asyncdownloader.repository.load.data.DataFetcher} as well as an
   ...
   *               {@link com.metao.asyncdownloader.repository.request.target.Target#SIZE_ORIGINAL} to indicate that
