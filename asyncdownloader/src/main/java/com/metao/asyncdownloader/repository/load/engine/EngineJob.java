...
class EngineJob<R> implements DecodeJob.Callback<R>,
  ...
  private final ImageDownloaderExecutor diskCacheExecutor;
  private final ImageDownloaderExecutor sourceExecutor;
  private final ImageDownloaderExecutor sourceUnlimitedExecutor;
  ...
  private ImageDownloaderException exception;
  ...
  EngineJob(ImageDownloaderExecutor diskCacheExecutor, ImageDownloaderExecutor sourceExecutor,
  ...
  public void start(DecodeJob<R> decodeJob) {
    ...
    ImageDownloaderExecutor executor = decodeJob.willDecodeFromCache()
        ? diskCacheExecutor
  ...
  private ImageDownloaderExecutor getActiveSourceExecutor() {
