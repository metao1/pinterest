...
/**
 * The standard concrete implementation of {@link com.metao.asyncdownloader.repository.request.BaseRequestOptions}.
 *
 * <p> Uses with custom types, transformations, or options can subclass and customize. {@link
 * com.metao.asyncdownloader.repository.request.BaseRequestOptions}. </p>
 */
...
public final class RequestOptions extends BaseRequestOptions<RequestOptions> {
  ...
  /**
   * Returns a {@link com.metao.asyncdownloader.repository.request.RequestOptions} with {@link
  ...
  /**
   * Returns a new {@link com.metao.asyncdownloader.repository.request.RequestOptions} with {@link #dontAnimate()}
   * called.
   */
