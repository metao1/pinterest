...
import com.metao.asyncdownloader.repository.load.data.DataRewinderRegistry;
import com.metao.asyncdownloader.repository.load.engine.DecodePath;
import com.metao.asyncdownloader.repository.load.engine.LoadPath;
...
import com.metao.asyncdownloader.repository.load.model.ModelLoaderRegistry;
import com.metao.asyncdownloader.repository.core.ResourceTranscoder;
import com.metao.asyncdownloader.repository.core.TranscoderRegistry;
import com.metao.asyncdownloader.repository.provider.EncoderRegistry;
import com.metao.asyncdownloader.repository.provider.ImageHeaderParserRegistry;
import com.metao.asyncdownloader.repository.provider.LoadPathCache;
import com.metao.asyncdownloader.repository.provider.ModelToResourceClassCache;
import com.metao.asyncdownloader.repository.provider.ResourceDecoderRegistry;
import com.metao.asyncdownloader.repository.provider.ResourceEncoderRegistry;
...
public class Registry {
  ...
  /**
   * Use the given factory to build a {@link com.metao.asyncdownloader.repository.imagehandler.load.model.ModelLoader} for models
  ...
  /**
   * Thrown when no {@link com.metao.asyncdownloader.repository.imagehandler.load.model.ModelLoader} is registered for a given
   * model class.
   */
