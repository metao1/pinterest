package com.metao.asyncdownloader.repository.load.resource.drawable;

import android.graphics.drawable.Drawable;
import com.metao.asyncdownloader.repository.core.TransitionOptions;
import com.metao.asyncdownloader.repository.request.transition.DrawableCrossFadeFactory;
...
public final class DrawableTransitionOptions extends
   ...
   *
   * @see com.metao.asyncdownloader.repository.imagehandler.GenericTransitionOptions#with(TransitionFactory)
   */
   ...
   * @see com.metao.asyncdownloader.repository.request.transition.DrawableCrossFadeFactory.Builder
   */
