...
/**
 * Generates {@link com.metao.asyncdownloader.repository.load.data.DataFetcher DataFetchers} from original source data
 * using registered {@link com.metao.asyncdownloader.repository.load.model.ModelLoader ModelLoaders} and the model
...
class SourceGenerator implements DataFetcherGenerator,
  ...
  public void onDataReady(Object data) {
    ...
    if (data != null && diskCacheStrategy.isDataCacheable(loadData.fetcher.getDataSource())) {
      ...
      // reschedule to get back onto ImageDownloader's thread.
      cb.reschedule();
    } else {
