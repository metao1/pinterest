...
/**
 * An {@link com.metao.asyncdownloader.repository.load.ResourceEncoder} that writes {@link Bitmap}s
...
public class BitmapEncoder implements ResourceEncoder<Bitmap> {
  ...
  public static final Option<Integer> COMPRESSION_QUALITY = Option.memory(
      "com.metao.asyncdownloader.repository.core.BitmapEncoder.CompressionQuality", 90);
  ...
  public static final Option<Bitmap.CompressFormat> COMPRESSION_FORMAT = Option.memory(
      "com.metao.asyncdownloader.repository.core.BitmapEncoder.CompressionFormat");
