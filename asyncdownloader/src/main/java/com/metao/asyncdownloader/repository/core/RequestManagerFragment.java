 ...
 * com.metao.asyncdownloader.repository.imagehandler.RequestManager} that can be used to start, stop and manage ImageDownloader requests
 ...
 * @see com.metao.asyncdownloader.repository.imagehandler.RequestManager
 */
...
public class RequestManagerFragment extends Fragment {
  ...
  /**
   * Sets the current {@link com.metao.asyncdownloader.repository.imagehandler.RequestManager}.
   *
  ...
  /**
   * Returns the current {@link com.metao.asyncdownloader.repository.imagehandler.RequestManager} or null if none exists.
   */
  @Nullable
